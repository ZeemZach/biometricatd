...
*/
$sql = "SELECT student_register1.NAME,student_register1.ROLL_NO,student_register1.CURRENT_COURSE,student_register1.CURRENT_YEAR,todays_att.day FROM student_register1 INNER JOIN todays_att ON student_register1.fg_id=todays_att.fg_id ORDER BY todays_att.day DESC LIMIT 33";
$result = $conn->query($sql);
echo '<!DOCTYPE html>';

echo'<html>
    <head>
     <!-- <meta http-equiv="refresh" content="5;url=https://biometricatd.000webhostapp.com/all_time_atd.php">-->
     <title>EVERYDAY_ATTENDANCE</title>
